...
func _setup_ui_from_profile() -> void:
	...
	_configure_slider(music_slider, _get_setting("music_volume", 0.7), 0.0, 1.0, 0.05)
	_configure_slider(sfx_slider, _get_setting("sfx_volume", 0.8), 0.0, 1.0, 0.05)
...
func _on_zoom_sensitivy_changed() -> void:
